...
export default function BlogPage() {
  const posts = [
    ...
    },
    {
      ...
      excerpt:
        'How I turned a weekend project into a business generating $5k MRR within 6 months.',
    ...
    },
    {
      ...
      excerpt:
        'A detailed breakdown of the technologies, frameworks, and services that power my products.',
    ...
    },
    {
      ...
      date: 'January 5, 2024',
      excerpt:
        'How to leverage your technical skills to identify profitable market opportunities.',
    ...
    <div className='py-10 space-y-8'>
      <div className='space-y-4'>
        ...
        <p className='text-muted-foreground'>
          Thoughts, stories, and ideas about development, indie hacking, and
          building in public.
        </p>
      </div>
